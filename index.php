...
<body style="background-color:#f6f5f5">
    ...
    <div class="container-fluid" style="margin-top: 15px;margin-bottom:15px;">
        <div class="row">
            <div class="col-sm-2">
                <button onclick="location.href='./ABCM_USUARIOS/F01.php'"><img src="./IMAGENES/Gerente.jpg" width="150px" height="150px">
                    <center>Administrador/Gerente</center>
                </button>
            </div>
            <div class="col-sm-2">
                <button onclick="location.href='./ABCM_MATERIALES/F03.php'"><img src="./IMAGENES/EmpleadoGeneral.jpg" width="150px" height="150px">
                    <center>Empleado General</center>
                </button>
            </div>
            <div class="col-sm-2">
                <button onclick="location.href='./ABCM_PRODUCTOS/F04.php'"><img src="./IMAGENES/Florista.jpg" width="150px" height="150px">
                    <center>Florista</center>
                </button>
            </div>
            <div class="col-sm-2">
                <button onclick="location.href='./IMPORTACION_INSUMOS/Fx.php'"><img src="./IMAGENES/Proveedor.jpg" width="150px" height="150px">
                    <center>Proveedor</center>
                </button>
            </div>
            <div class="col-sm-2">
                <button onclick="location.href='./EXPORTACION_INSUMOS/Fx.php'"><img src="./IMAGENES/Distribuidor.jpg" width="150px" height="150px">
                    <center>Distribuidor</center>
                </button>
            </div>
            <div class="col-sm-2">
                <button onclick="location.href='./PROCESO_DE_VENTA/fx.php'"><img src="./IMAGENES/clientes.jpg" width="150px" height="150px">
