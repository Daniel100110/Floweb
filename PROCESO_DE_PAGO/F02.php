                ...
                $f02_p_saldo = get_saldo();
                    if($f02_p_saldo >= $f02_p_total){
                        ...
                        if ($f02_p_res_01 -> num_rows > 0) {
                            ...
                            $f02_p_res_02 = "insert into pedido (correo_cuenta,lista_productos,subtotal_pedido,iva_pedido,total_pedido) values ('$f02_p_correo','$f02_p_lista_productos','$f02_p_subtotal','$f02_p_iva','$f02_p_total');";
            ...
            if (isset($_POST['datos'])) {
                ...
                if ($result_06 -> num_rows > 0) 
                {
                    ...
                    if ($conn->query($sql_054)) {
                      echo "<script>swal('¡Producto actualizado!', '¡Se ha agregado!', 'success');</script>";
                    } else {
                      echo "<script>swal('¡Error2!', '¡No se ha agregado!', 'error');</script>";
                    }
                } 
                else 
                { 
